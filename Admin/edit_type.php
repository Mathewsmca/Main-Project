...
if(isset($_GET["type_id"]))
{
	...
	$sql=mysqli_query($conn,"SELECT * FROM tbl_type WHERE type_id='$type_id'");
...
<h2 style="text-align: center;margin-top: 6%;">TYPE EDIT</h2>
  <br>
   <div class="row">
...
if(isset($_POST["btnsubmit"]))
{
	...
	$sql=mysqli_query($conn,"UPDATE tbl_type SET type='$typename',Description='$typedescription'WHERE type_id='$type_id'");
	if($sql)
	{
