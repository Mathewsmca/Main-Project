  ...
  <div  style="margin-left:124px; margin-bottom:5%;padding-left:-25px; box-shadow: 2px 2px 10px #000000; border-radius: 4px; top: 14px;padding-top:5%;">
    ...
    <div style="min-height: 80%;">
     ...
     while($row=mysqli_fetch_array($result))
							{
								?>
      <div  style="box-shadow: 3px 3px 10px #000; border-radius: 10px; top: 34px;width: 260px;height:439px;background-color: #808080;color: white;margin-left:7%;;margin-top:8%;margin-bottom:15%;margin-right:6px%;"> 
      <?php echo "<a style='color:#090' href='#?p_id=".$row['cab_id']."'>";?>
        ...
        <div style="text-align: center"> <b> <img src="../img/<?php echo $row['image'] ?>" width="250px" height="200px"/>
          <p style="color:black">Cab Number:</p>
          <p style="color:green">
