...
<form action="viewcab.php" style="    padding-top: 7%;background-image:url(images/about-img.jpg) ;background-repeat: no-repeat;background-size: cover;">
    ...
    <div  style="min-height: 50%;">
     ...
     while($row=mysqli_fetch_array($result))
							{
								?>
      <div  style="box-shadow: 3px 3px 10px #000; border-radius: 10px; top: -34px;width: 260px;height: 120px;background-color: #ecf0f3;color: #ecf0f3;margin-left:40%;;margin-top:8%;margin-bottom:15%;margin-right:6px%;">
