<?php
    ...
    if(isset($_POST['signup']))
    {
        ...
        $reg= mysqli_query($conn,"INSERT INTO `tbl_customer`(`name`, `email`, `password`, `phone`, `gender`, `status`)  VALUES ( '$name', '$email', '$pass', '$phone','$gender', '$status')");
     if($reg)
     {
echo "<script> alert ('Thank you for Registrtion !!!');window.location='login.php'</script>";
     }
    }
?>
